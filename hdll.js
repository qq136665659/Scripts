...
const ckName = "TOKEN_APP_c5430087-7328-41f3-8de5-cacab788ae14";//环境变量声明
//-------------------- 一般不动变量区域 -------------------------------------
...
$.notifyMsg = [];
//bark推送
$.barkKey = ($.isNode() ? process.env["https://api.day.app/QwfpKP7vHcst8QX9gXkwkg/"] : $.getdata("bark_key")) || '';
//---------------------- 自定义变量区域 -----------------------------------
